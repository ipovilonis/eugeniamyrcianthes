...
p_long <- reshape2::melt(p_matrix, varnames = c("Variable1", "Variable2"), value.name = "PValue")
...
cor_long <- reshape2::melt(cor_matrix, varnames = c("Variable1", "Variable2"), value.name = "Correlation")
